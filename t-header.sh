...
rubygem_d &> /dev/null
termux-wake-lock;
if [ -e $PREFIX/share/figlet/Jadels.flf ]; then
	echo -e "\e[1;34m[*] \033[32mJadels.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/poisk-ls/JADELS/master/Jadels.flf &> /dev/null;
sleep 3
cp Jadels.flf $PREFIX/share/figlet/Jadels.flf
...
#echo -e '\033[1;43;30m### BE LIMITLESS AND KNOW YOUR WORTH  ### \033[0m';
#echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
echo -e "
...
clear;
echo -e "\033[31m$(figlet -f Jadels "T- Header")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
Jadels.flf : (\e[33m14.4.2021\e[32m)
